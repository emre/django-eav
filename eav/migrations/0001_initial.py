# Generated by Django 2.0.4 on 2018-06-06 08:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='contenttypes.ContentType', verbose_name='content type')),
            ],
            options={
                'db_table': 'attributes',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True, verbose_name='modified')),
                ('attribute', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='eav.Attribute', verbose_name='attribute')),
                ('entity_ct', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='value_entities', to='contenttypes.ContentType')),
                ('generic_value_ct', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='value_values', to='contenttypes.ContentType')),
                ('value_enum', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='eav_values', to='eav.EnumValue')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='enum_group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='eav.EnumGroup', verbose_name='choice group'),
        ),
    ]
